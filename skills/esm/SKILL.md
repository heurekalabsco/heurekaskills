---
name: esm
description: Run EvolutionaryScale ESM protein language models — ESM3 sequence and structure generation, ESMC embeddings, inverse folding, and ESMFold2 structure prediction, locally or through the hosted Biohub API.
category: models
license: MIT
...
- `esmc-6b-2024-12` (80 layers) - Maximum quality (hosted API; local 6B weights require the hosted platform or SageMaker)
